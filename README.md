...
<p align="center">
  <img src="./assets/profile-hero.png" width="100%" alt="ivmz developer profile" />
</p>
...
<table width="100%">
  <tr>
    <td width="33%" align="center"><strong>● BUILDING</strong><br/><sub>last public activity · 20:28 JST</sub></td>
    <td width="34%" align="center"><strong>🌩️ STORM</strong><br/><sub>80 public actions today</sub></td>
...
<p align="center"><sub>2026-08-30 JST · public GitHub activity</sub></p>

<table width="100%">
  <tr>
    <td width="25%" align="center"><strong>54</strong><br/><sub>COMMITS</sub></td>
    <td width="25%" align="center"><strong>18</strong><br/><sub>PRS OPENED</sub></td>
...
<table width="100%">
  <tr>
    <td width="62%" valign="top"><strong><a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong><br/><sub>weighted activity 72% · score 233 · 158 events</sub></td>
...
<table width="100%">
  <tr>
    ...
    <td width="25%" align="center"><strong>25 / 28</strong><br/><sub>PASSED / EVALUATED</sub></td>
...
<table width="100%"><tr><td width="33%" valign="top"><strong>01 · <a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong><br/><sub>76% weighted · HEALTHY · CI pass rate 90%<br/>last activity · 16:55 JST</sub></td><td width="33%" valign="top"><strong>02 · <a href="https://github.com/ivRooom/ivrm-status">ivRooom/ivrm-status</a></strong><br/><sub>15% weighted · WATCH · CI pass rate 78%<br/>last activity · 16:28 JST</sub></td><td width="33%" valign="top"><strong>03 · <a href="https://github.com/ivRooom/Herta">ivRooom/Herta</a></strong><br/><sub>8% weighted · HEALTHY · CI pass rate 100%<br/>last activity · 09:51 JST</sub></td></tr></table>
...
<table width="100%">
  <tbody>
    <tr><td width="10%"><code>20:28</code></td><td width="14%"><code>CREATE</code></td><td><strong><a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong> — <a href="https://github.com/ivRooom/ivrm-dashboard">Created branch feat/console-login-consistency-phase-d12</a></td></tr>
    <tr><td width="10%"><code>20:26</code></td><td width="14%"><code>ISSUE</code></td><td><strong><a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong> — <a href="https://github.com/ivRooom/ivrm-dashboard/issues/73">Issue #73を完了</a></td></tr>
    <tr><td width="10%"><code>20:25</code></td><td width="14%"><code>PUSH</code></td><td><strong><a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong> — <a href="https://github.com/ivRooom/ivrm-dashboard/commits">feat/status-center-maintenance-mutationsへ1コミットをPush</a></td></tr>
    <tr><td width="10%"><code>20:22</code></td><td width="14%"><code>PUSH</code></td><td><strong><a href="https://github.com/ivRooom/ivrm-dashboard">ivRooom/ivrm-dashboard</a></strong> — <a href="https://github.com/ivRooom/ivrm-dashboard/commits">feat/status-center-maintenance-mutationsへ1コミットをPush</a></td></tr>
  </tbody>
</table>
...
`Repository中心の開発` `Security by Design` `自動テスト` `Accessibility` `Observability` `Least Privilege` `Fail-close` `Release Automation`
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Discord Community Platform</strong></p>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Discord × Realtime Voice AI / Windows Desktop</strong></p>
      <p>Realtime Voice AI、Discord Voice、割り込み、Secret保護、Electron Desktop、Installer / Releaseまで扱うOSS。</p>
...
<table width="100%">
  <tr>
    ...
    <td width="25%" align="center"><strong>1554</strong><br/><sub>COMMITS · THIS WEEK</sub></td>
    <td width="25%" align="center"><strong>145</strong><br/><sub>PRS · THIS WEEK</sub></td>
    <td width="25%" align="center"><strong>51</strong><br/><sub>ISSUES DONE · THIS WEEK</sub></td>
  </tr>
</table>
...
<br/>
<table width="100%"><tr><td width="25%" align="center"><strong>1554</strong><br/><sub>COMMITS</sub></td><td width="25%" align="center"><strong>145</strong><br/><sub>PRS</sub></td><td width="25%" align="center"><strong>51</strong><br/><sub>ISSUES DONE</sub></td><td width="25%" align="center"><strong>1827</strong><br/><sub>ACTIVITY</sub></td></tr></table>
</details>

<details>
<summary><strong>YEARLY SUMMARY // 2026</strong></summary>
<br/>
<table width="100%"><tr><td width="20%" align="center"><strong>6</strong><br/><sub>ACTIVE DAYS</sub></td><td width="20%" align="center"><strong>1554</strong><br/><sub>COMMITS</sub></td><td width="20%" align="center"><strong>145</strong><br/><sub>PRS</sub></td><td width="20%" align="center"><strong>51</strong><br/><sub>ISSUES DONE</sub></td><td width="20%" align="center"><strong>1827</strong><br/><sub>ACTIVITY</sub></td></tr></table>
